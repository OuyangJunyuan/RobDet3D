...
class PointHeadVote(PointHeadTemplate):
    ...
    def get_cls_layer_loss(self, tb_dict=None):
        ...
        # to print point-pos-num in test time
        # self.count = getattr(self, 'count', 0)
        # self.count += 1
        # self.positives = getattr(self, 'positives', 0)
        # self.positives += positives.sum().item()
        # print(self.positives / self.count, '\n')
    ...
    def forward(self, batch_dict):
        ...
        # self.get_cls_layer_loss() # to print point-pos-num in test time
        return batch_dict
